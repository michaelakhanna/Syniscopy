...
\usepackage[colorlinks=true,
            ...
            pdftitle={Syniscopy: Theoretical Foundations and Cross-Modality Cramer-Rao Analysis for Synthetic Single-Particle Microscopy},
...
% Title block
% -------------------------------------------------------------------------
\title{Syniscopy: Theoretical Foundations and Cross-Modality\\
       Cram\'{e}r--Rao Analysis for\\
       Synthetic Single-Particle Microscopy}
...
\input{sections/03_physical_model}
