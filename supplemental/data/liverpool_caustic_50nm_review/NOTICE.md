...
This folder contains reviewed clips derived from Genevieve Schleyer's
University of Liverpool DataCat dataset, "Raw video files: Caustic signatures
produced by gold nanoparticles."
...
this Syniscopy source tree. The selected clips retain source-video identifiers,
frame windows, prompt-frame coordinates, and audit metadata needed by the
caustic-video transfer notebooks.
